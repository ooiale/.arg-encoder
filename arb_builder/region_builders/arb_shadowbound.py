...
def build_shadowbound_region(shadowbound: ShadowBound) -> bytes:
    ...
    output += _encode_float(shadowbound.bound1)
    output += _encode_float(shadowbound.bound2)
    output += _encode_float(shadowbound.dist)
    output += _encode_float(shadowbound.near)
    output += _encode_float(shadowbound.far)
...
if __name__ == "__main__":
    ...
    #print(arg)
    print(arg.shadow_bound)
    if arg.shadow_bound:
        data1 = build_shadowbound_region(arg.shadow_bound)
        print(data1)
    else:
        print('no shadowbound')